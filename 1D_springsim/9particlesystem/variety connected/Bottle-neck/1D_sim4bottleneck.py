## particle 4 is bottle neck (not at center of mass/ geometry)
...
outputfile = open("1D_allosterysim4.dat","w")
var_string = "#"
...
data = np.loadtxt("1D_allosterysim4.dat")
...
plt.savefig("9N_positionhist4.pdf",dpi=600,transparant=True)
plt.close()
...
plt.savefig("9N_forceshist4.pdf",dpi=600,transparant=True)
plt.close()
...
plt.savefig("9N_velocitieshist4.pdf",dpi=600,transparant=True)
plt.close()
...
plt.xlim((0,250))
plt.savefig("9N_positionvstime4.pdf",dpi=600,transparant=True)
plt.close()
...
plt.legend(loc='upper left')
plt.savefig("9N_velocitiesvstime4.pdf",dpi=600,transparant=True)
plt.close()
